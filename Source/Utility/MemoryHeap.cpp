...
CMemoryHeap* CMemoryHeap::Create(void* base_ptr, u32 size) { return new IMemoryHeap(base_ptr, size); }
...
bool IMemoryHeap::IsFromHeap(void* ptr) const { return ptr >= mBasePtr && ptr < (mBasePtr + mTotalSize); }
