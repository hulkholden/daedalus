...
class CRefCounted
{
   ...
   protected:
	virtual ~CRefCounted() { DAEDALUS_ASSERT(mRefCount == 0, "Prematurely deleting refcounted object?"); }
...
class CRefPtr
{
   public:
	...
	_NoAddRefRelease<T>* operator->() const { return (_NoAddRefRelease<T>*)mPtr; }
