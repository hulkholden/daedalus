...
{
	bool operator()(const SFragmentCount& a, const SFragmentCount& b) const { return a.Count > b.Count; }
};
}
...
void LogEnterExit(u32 enter_address, u32 exit_address, u32 instruction_count)
{
	...
	DAED_LOG(DEBUG_DYNAREC_CACHE, "Enter/Exit: %08x -> %08x (executed %d instructions)", enter_address, exit_address,
			 instruction_count);
}
}
